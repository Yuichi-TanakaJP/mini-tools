...
const FALLBACK_HEATMAP: Record<string, number[]> = {
  "銀行業": [1.42, 0.68, -0.24, 0.91, 0.55, 1.16],
  "情報・通信業": [0.88, 0.14, 0.52, -0.18, 0.73, 0.64],
  "電気機器": [-0.92, 1.18, 0.44, 0.26, -0.35, 0.81],
  "卸売業": [0.63, -0.11, 0.38, 0.74, 0.49, -0.05],
  "輸送用機器": [-1.31, -0.44, 0.27, -0.63, 0.16, 0.33],
  "不動産業": [-0.58, -0.84, 0.12, -0.47, -0.19, 0.09],
};

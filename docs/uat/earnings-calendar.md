...
- [ ] 今日・明日に保有銘柄の決算がある場合、「決算: 保有/ウォッチ」に表示される
- [ ] 今日・明日にウォッチ銘柄の決算がある場合、「決算: 保有/ウォッチ」に表示される
- [ ] 今日・明日に日経225採用銘柄の決算がある場合、「決算: 日経225」に表示される
- [ ] 保有/ウォッチ銘柄が日経225採用銘柄でも、2つの枠に重複表示されない
- [ ] 日経225寄与度データを取得できない場合も、保有/ウォッチと決算件数の通知は表示できる

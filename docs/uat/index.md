...
- [データ入出力](./data-transfer.md): 優待DBの全件出力・読み戻し照合。
...
| TDNET適時開示一覧 | `/tools/tdnet-disclosures` | API のみ | [tdnet-disclosures.md](./tdnet-disclosures.md) |
| 開示イベントレーダー | `/tools/disclosure-radar` | API + LocalStorage | [disclosure-radar.md](./disclosure-radar.md) |
| 投資主体別売買動向 | `/tools/investor-flow` | API のみ | [investor-flow.md](./investor-flow.md) |
